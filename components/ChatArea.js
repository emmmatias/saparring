...
function ChatArea({ interviewType, technologies, level, userName, onRestart }) {
    ...
    <Grid container spacing={2}>
      <Grid item xs={12} md={4}>
        <Paper elevation={3} sx={{ p: 2, height: '100%' }}>
          <Typography variant="h6" gutterBottom sx={{ display: 'flex', alignItems: 'center' }}>
            <EmojiEventsIcon sx={{ mr: 1, color: 'primary.main' }} />
            Progreso del Sparring
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography variant="body2" gutterBottom>
            <strong>Entrevistado:</strong> {userName}
          </Typography>
          <Typography variant="body2" gutterBottom>
            <strong>Tipo:</strong> {interviewType}
          </Typography>
          <Typography variant="body2" gutterBottom>
          ...
          <Typography variant="body2" gutterBottom>
            <strong>Progreso:</strong> {currentQuestionIndex}/{totalQuestions}
          </Typography>
        </Paper>
      </Grid>
      <Grid item xs={12} md={8}>
        {questions.map((q, index) => (
          <Accordion 
            key={index} 
            expanded={index === currentQuestionIndex - 1}
          ...
          >
            ...
            <AccordionDetails>
              ...
              {index === currentQuestionIndex - 1 && !q.answer && (
